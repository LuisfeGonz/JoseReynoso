<%@ Page Title="" Language="C#" MasterPageFile="~/Formularios/General/General1.Master" AutoEventWireup="true" CodeBehind="cambiarClave.aspx.cs" Inherits="BanQuetzal.Formularios.General.cambiarClave" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 style="font-family: Algerian; font-size: 40px; color: #003366; text-align: center">
        <a href="../Usuarios/InicioServicio.aspx">
        INICIO
        </a>
    </h1>
    <br />
