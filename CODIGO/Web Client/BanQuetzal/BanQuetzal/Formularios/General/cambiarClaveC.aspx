<%@ Page Title="" Language="C#" MasterPageFile="~/Formularios/General/General1.Master" AutoEventWireup="true" CodeBehind="cambiarClaveC.aspx.cs" Inherits="BanQuetzal.Formularios.General.cambiarClaveC" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 style="font-family: Algerian; font-size: 40px; color: #003366; text-align: center">
        <a href="../Cajero/inicioCajero.aspx">
        INICIO
        </a>
    </h1>
    <br />
